...
namespace Mybatis.DataAccess.Exceptions
{
	/// <summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.DataAccess.Exceptions.DataAccessException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.DataAccess.Exceptions.DataAccessException"/> 
