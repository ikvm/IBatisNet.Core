...
namespace Mybatis.Common.Exceptions
{
	...
	public class ConfigurationException : IBatisNetException
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Common.Exceptions.ConfigurationException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Common.Exceptions.ConfigurationException"/> 
