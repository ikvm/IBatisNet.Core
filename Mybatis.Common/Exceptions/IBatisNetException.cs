...
namespace Mybatis.Common.Exceptions
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Common.Exceptions.IBatisNetException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Common.Exceptions.IBatisNetException"/> 
