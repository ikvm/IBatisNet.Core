...
using Mybatis.Mapper.Commands;
using Mybatis.Mapper.Configuration.ParameterMapping;
using Mybatis.Mapper.Configuration.Statements;
using Mybatis.Mapper.MappedStatements.ResultStrategy;
using Mybatis.Mapper.Scope;
using Mybatis.Mapper.MappedStatements.PostSelectStrategy;
using Mybatis.Mapper.Exceptions;
using Mybatis.Mapper.TypeHandlers;

#endregion

namespace Mybatis.Mapper.MappedStatements
{
    ...
    public class MappedStatement : IMappedStatement
    {
        ...
        ///<exception cref="Mybatis.Mapper.Exceptions.DataMapperException">If a transaction is not in progress, or the database throws an exception.</exception>
