...
using Mybatis.Mapper.Configuration.Alias;
...
using Mybatis.Mapper.Configuration.ParameterMapping;
using Mybatis.Mapper.Configuration.ResultMapping;
using Mybatis.Mapper.Configuration.Serializers;
using Mybatis.Mapper.Configuration.Sql;
using Mybatis.Mapper.Configuration.Sql.Dynamic;
using Mybatis.Mapper.Configuration.Sql.Dynamic.Elements;
using Mybatis.Mapper.Configuration.Sql.SimpleDynamic;
using Mybatis.Mapper.Configuration.Sql.Static;
using Mybatis.Mapper.Configuration.Statements;
using Mybatis.Mapper.MappedStatements;
using Mybatis.Mapper.MappedStatements.ArgumentStrategy;
using Mybatis.Mapper.MappedStatements.PropertyStrategy;
using Mybatis.Mapper.Scope;
using Mybatis.Mapper.TypeHandlers;

#endregion

namespace Mybatis.Mapper.Configuration
{
    /// <summary>
    ...
    /// </summary>
    private const string XML_DATAMAPPER_CONFIG_ROOT = "configuration";//"sqlMapConfig";

        /// <summary>
        /// Token for xml path to SqlMapConfig settings element.
        /// </summary>
        private const string XML_CONFIG_SETTINGS = XML_DATAMAPPER_CONFIG_ROOT + "/settings/setting";
        ...
        /// </summary>
        private const string XML_CONFIG_PROVIDERS = XML_DATAMAPPER_CONFIG_ROOT + "/providers";
        ...
        /// </summary>
        private const string XML_DATABASE_PROVIDER = XML_DATAMAPPER_CONFIG_ROOT + "/database/provider";

        /// <summary>
        /// Token for xml path to database source elements.
        /// </summary>
        private const string XML_DATABASE_DATASOURCE = XML_DATAMAPPER_CONFIG_ROOT + "/database/dataSource";

        /// <summary>
        /// Token for xml path to global type alias elements.
        /// </summary>
        private const string XML_GLOBAL_TYPEALIAS = XML_DATAMAPPER_CONFIG_ROOT + "/alias/typeAlias";

        /// <summary>
        /// Token for xml path to global type alias elements.
        /// </summary>
        private const string XML_GLOBAL_TYPEHANDLER = XML_DATAMAPPER_CONFIG_ROOT + "/typeHandlers/typeHandler";

        /// <summary>
        /// Token for xml path to global type alias elements.
        /// </summary>
        private const string XML_GLOBAL_MAPMODULE = XML_DATAMAPPER_CONFIG_ROOT + "/modules/module";

        /// <summary>
        /// Token for xml path to sqlMap elements.
        /// </summary>
        private const string XML_SQLMAP = XML_DATAMAPPER_CONFIG_ROOT + "/mappers/mapper";

        /// <summary>
        /// Token for xml path to module sqlMap elements.
        /// </summary>
        private const string XML_MODULE_MAP = "module/mappers/mapper";

        /// <summary>
        /// Token for mapping xml root.
        /// </summary>
        private const string XML_MAPPING_ROOT = "mapper";

        /// <summary>
        /// Token for xml path to type alias elements.
        /// </summary>
        private const string XML_TYPEALIAS = XML_MAPPING_ROOT + "/alias/typeAlias";

        /// <summary>
        /// Token for xml path to resultMap elements.
        /// </summary>
        private const string XML_RESULTMAP = XML_MAPPING_ROOT + "/resultMaps/resultMap";

        /// <summary>
        /// Token for xml path to parameterMap elements.
        /// </summary>
        private const string XML_PARAMETERMAP = XML_MAPPING_ROOT + "/parameterMaps/parameterMap";

        /// <summary>
        /// Token for xml path to sql elements.
        /// </summary>
        private const string SQL_STATEMENT = XML_MAPPING_ROOT + "/statements/sql";
            
        /// <summary>
        /// Token for xml path to statement elements.
        /// </summary>
        private const string XML_STATEMENT = XML_MAPPING_ROOT + "/statements/statement";

        /// <summary>
        /// Token for xml path to select elements.
        /// </summary>
        private const string XML_SELECT = XML_MAPPING_ROOT + "/statements/select";

        /// <summary>
        /// Token for xml path to insert elements.
        /// </summary>
        private const string XML_INSERT = XML_MAPPING_ROOT + "/statements/insert";
        ...
        /// </summary>
        private const string XML_UPDATE = XML_MAPPING_ROOT + "/statements/update";

        /// <summary>
        /// Token for xml path to delete elements.
        /// </summary>
        private const string XML_DELETE = XML_MAPPING_ROOT + "/statements/delete";

        /// <summary>
        /// Token for xml path to procedure elements.
        /// </summary>
        private const string XML_PROCEDURE = XML_MAPPING_ROOT + "/statements/procedure";

        /// <summary>
        /// Token for xml path to cacheModel elements.
        /// </summary>
        private const string XML_CACHE_MODEL = XML_MAPPING_ROOT + "/cacheModels/cacheModel";
        ...
        /// </summary>
        private const string XML_SEARCH_STATEMENT = XML_MAPPING_ROOT + "/statements";

        /// <summary>
        /// Token for xml path to search parameterMap elements.
        /// </summary>
        private const string XML_SEARCH_PARAMETER = XML_MAPPING_ROOT + "/parameterMaps/parameterMap[@id='";

        /// <summary>
        /// Token for xml path to search resultMap elements.
        /// </summary>
        private const string XML_SEARCH_RESULTMAP = XML_MAPPING_ROOT + "/resultMaps/resultMap[@id='";
            ...
            bool useConfigFileWatcher, bool isCallFromDao)
        {
            ...
            try
            {
                ...
                {
                    ValidateSchema( document.ChildNodes[1], "configuration.xsd");
                }
                Initialize();
        ...
        private void ConfigureSqlMapModule()
        {
            ...
            {
                ValidateSchema(_configScope.SqlMapModuleDocument.ChildNodes[1], "module.xsd");
            }
        ...
        private void ConfigureSqlMap( )
        {
            ...
            if (_configScope.ValidateSqlMap)
            {
                ValidateSchema( _configScope.SqlMapDocument.ChildNodes[1], "mapper.xsd" );
            }
