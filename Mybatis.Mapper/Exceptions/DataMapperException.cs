...
namespace Mybatis.Mapper.Exceptions
{
	/// <summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Mapper.Exceptions.DataMapperException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Mybatis.Mapper.Exceptions.DataMapperException"/> 
