...
using Mybatis.Mapper.SessionStore;
using Mybatis.Mapper.Test.Domain;
using NUnit.Framework;
using System.Collections.Specialized;
using Mybatis.DataAccess.SessionStore;
...
namespace Mybatis.Mapper.Test.NUnit.SqlMapTests
{
	...
	public class ConfigureTest : BaseTest 
	{
	    ...
	    {
            sqlMap.SessionStore = new SessionStore.AsyncLocalSessionStore(sqlMap.Id);
		...
		{
			// embeddedResource = "bin.Debug.SqlMap_MSSQL_SqlClient.config, Mybatis.Mapper.Test";
			
            Assembly assembly = Assembly.Load("Mybatis.Mapper.Test");
			Stream stream = assembly.GetManifestResourceStream("Mybatis.Mapper.Test.SqlMap_MSSQL_SqlClient.config");
