...
grant all privileges on Mybatis.* to IBatisNet@'%' identified by 'test';
grant all privileges on Mybatis.* to IBatisNet@localhost identified by 'test';
grant all privileges on Mybatis.* to IBatisNet@localhost.localdomain identified by 'test';
